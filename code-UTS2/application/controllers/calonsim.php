...
class calonsim extends CI_Controller {
   ...
   public function __construct(){
    ...
    public function index()
    {
        ...
        $data['calonsim']=$this->calonsim_model->getAllcalonsim();
        if($this->input->post('keyword')){
            $data['calonsim']=$this->calonsim_model->cariDatacalonsim();//cariDataMahasiswa
        }
    ...
    public function tambah(){
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->calonsim_model->tambahdatacalonsim();//tambahdatamhs
    ...
    public function hapus($id){
        $this->calonsim_model->hapusdatacalonsim($id);//hapusdatamhs
    ...
    public function detail($id){
        ...
        $data['calonsim']=$this->calonsim_model->getcalonsimByID($id);//getmahasiswaByID
        $this->load->view('template/header',$data);
    ...
    public function edit($id)
    {
        ...
        $data['calonsim'] =$this->calonsim_model->getcalonsimByID($id);
        $data['provinsi'] = ['jawa timur','jawa tengah','jawa barat','sulawesi selatan','sulawesi utara','sumatra barat'];
        $data['jeniskelamin']=['Perempuan','Laki-laki'];
        ...
        if ($this->form_validation->run() == FALSE)
                ...
                {
                        $this->calonsim_model->ubahdatacalonsim();//ubahdatamhs
